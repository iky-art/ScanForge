  ...
  return (
    <div className="flex flex-col items-center justify-center text-center py-20">
      ...
      <p className="font-mono text-xs text-sev-anomalous tracking-[0.15em] mt-4">
        SCANFORGE INTELLIGENCE
      </p>
      <h1 className="text-2xl font-semibold mt-2">AI Scanner</h1>
      <p className="font-mono text-xs text-ink-faint tracking-wide mt-3 border border-line px-3 py-1">
        COMING SOON — AVAILABLE IN v2.0.0
      </p>
      <p className="text-sm text-ink-dim max-w-md mt-6 leading-relaxed">
        AI-assisted analysis, contextual explanations, intelligent
        remediation, and deeper security insights are being prepared for the
        next major release.
      </p>
      <Link
        to="/scanner"
